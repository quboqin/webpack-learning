...
module.exports = function () {
  ...
  console.log(chalk.yellow(require('../../../assets/media/config.json')))
  console.log(chalk.yellow(fs.readFileSync(path.resolve(__dirname, '../../../assets/media/sometext.txt'), 'utf8')))
  console.log(chalk.red.bgYellow('the next readFileSync() will throw out an exception if the working directory is not the same as the directory the script resides!'))
